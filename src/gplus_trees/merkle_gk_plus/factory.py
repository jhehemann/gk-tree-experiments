...
def make_merkle_gk_plustree_classes(K: int) -> Tuple[
    Type[MerkleGKPlusTreeBase],
    Type[MerkleGKPlusNodeBase]
]:
    """
    ...
    GKPlusTreeK, GKPlusNodeK, KListK, KListNodeK = make_gkplustree_classes(K)
    ...
    MerkleGKPlusNodeK = type(
        ...
        {
            "SetClass": KListK,
            "__slots__": MerkleGKPlusNodeBase.__slots__
        }
    )
    ...
    setattr(MerkleGKPlusNodeK, "TreeClass", MerkleGKPlusTreeK)

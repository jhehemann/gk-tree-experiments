...
class BenchmarkUtils:
    ...
    def generate_deterministic_keys(
        size: int, seed: int | None = None, key_range: tuple[int, int] = (1, 1000000), distribution: str = "uniform"
    ) -> list[int]:
        """
    ...
    @staticmethod
    def create_lookup_keys(
        insert_keys: list[int], hit_ratio: float = 0.8, seed: int | None = None, num_lookups=1000
    ) -> list[int]:
        """

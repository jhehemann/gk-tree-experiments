...
class TestGKPlusTreeExpandedCountTracking(GKPlusTreeTestCase):
    ...
    def test_expansion_rank_1_dim_1(self):
        ...
        self.assertIsNone(tree.expanded_cnt,
                          "expanded_cnt should be None before triggering expanded_count()")
        self.assertEqual(tree.expanded_count(), len(dummy_keys) - 1,
                         "Expanded count should be equal to the number of dummy keys - 1 (first dimension) in the tree.")
        self.assertGreaterEqual(tree.expanded_count(), 1,
                         "Expanded count should be greater than 1")
        self.assertGreaterEqual(tree.expanded_cnt, 1,
                         "expanded_cnt should be greater than 1 after expanded_count() is called")
    ...
    def test_expansion_rank_gt_1_dim_1(self):
        ...
        self.assertIsNone(tree.expanded_cnt,
                          "expanded_cnt should be None before triggering expanded_count()")
        self.assertGreaterEqual(tree.expanded_count(), 0,
                         "Expanded count should be 0 after inserting one item (1 dummy + 1 item)")
        self.assertGreaterEqual(tree.expanded_cnt, 0,
    ...
    def test_multi_expansion_dim1_leaf(self):
        ...
        self.assertEqual(tree.expanded_count(), len(dummy_keys) - 1,
                         "Expanded count should be equal to the number of dummy keys - 1 (first dimension) in the tree.")
        self.assertGreaterEqual(tree.expanded_count(), 3,
                         "Expanded count should be greater than 3.")
        self.assertGreaterEqual(tree.expanded_cnt, 3,
                         "expanded_cnt should be greater than 3 after expanded_count() is called")
    ...
    def test_multi_expansion_dim1_leaf_dim2_leaf(self):
        ...
        self.assertEqual(tree.expanded_count(), len(dummy_keys) - 1,
                         "Expanded count should be equal to the number of dummy keys - 1 (first dimension) in the tree.")
        self.assertGreaterEqual(tree.expanded_count(), 2,
                         "Expanded count should be greater than 2")
        self.assertGreaterEqual(tree.expanded_cnt, 2,
                         "expanded_cnt should be greater than 2 after expanded_count() is called")
    ...
    def test_multi_expansion_different_dim_paths(self):
        ...
        self.assertEqual(tree.expanded_count(), len(dummy_keys) - 1,
                         "Expanded count should be equal to the number of dummy keys - 1 (first dimension) in the tree.")
        self.assertGreaterEqual(tree.expanded_count(), 5,
                 "Expanded count should be greater or equal to 5")
        self.assertGreaterEqual(tree.expanded_cnt, 5,
                 "expanded_cnt should be greater or equal to 5 after expanded_count() is called")

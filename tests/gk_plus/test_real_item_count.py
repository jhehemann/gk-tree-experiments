...
class TestGKPlusTreeRealItemCount(GKPlusTreeTestCase):
    ...
    def test_consistency_with_leaf_iteration(self):
        ...
        self.assertEqual(
            method_count, manual_count, f"Method count ({method_count}) should match manual count ({manual_count})"
        )
    ...
    def test_complex_multi_dimensional_tree(self):
        ...
        test_data = [(1, 1), (2, 2), (3, 1), (4, 3), (5, 1), (6, 2), (7, 1), (8, 4), (9, 1), (10, 2)]
        ...
        real_count = tree.real_item_count()
        self.assertEqual(real_count, len(test_data), f"Should have {len(test_data)} real items")
        self.validate_tree(tree)
    ...
    def test_get_size_method_consistency(self):
        ...
        self.assertEqual(real_count, size_count, "real_item_count() and get_size() should return the same value")

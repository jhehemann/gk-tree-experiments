...
class TestSetConversion(GKPlusTreeTestCase):
    def create_entries(self, keys: list[int], with_subtrees: bool | None = False) -> list[Entry]:
        """
        ...
        return [Entry(item, subtree) for item, subtree in zip(items, subtrees, strict=False)]

...
class TestGKPlusTreeUnzip(TreeTestCase):
    ...
    def _create_tree(self, keys: list[int], ranks: list[int], tree=None):
        ...
        for key, rank in zip(keys, ranks, strict=False):
    ...
    def _validate_tree_structure(
        self, tree: GKPlusTreeBase, expected_real_keys: list[int], description: str = "", is_right: bool = True
    ):
        """
    ...
    def _validate_unzip_result(
        self,
        left_tree: GKPlusTreeBase,
        key_subtree: GKPlusTreeBase | None,
        right_tree: GKPlusTreeBase,
        next_entry: Entry | None,
        unzip_key: int,
        expected_next_key: Entry,
        expected_left_keys: list[int],
        expected_right_keys: list[int],
        has_key_subtree: bool = False,
    ):
        ...
        if has_key_subtree:
            ...
            if key_subtree is not None:
                self.assertIsNone(key_subtree, f"Key subtree should be None when key {unzip_key} doesn't exist")
    ...
    def test_unzip_empty_tree(self):
        ...
        left_tree, key_subtree, _right_tree, next_entry = tree.unzip(100)
    ...
    def test_unzip_single_item_tree_key_not_exists_smaller(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=keys[0],
            expected_left_keys=[],
            expected_right_keys=keys,
            has_key_subtree=False,
        )
    ...
    def test_unzip_multiple_items_key_exists_middle(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=next_key,
            expected_left_keys=expected_left_keys,
            expected_right_keys=expected_right_keys,
            has_key_subtree=False,
        )
    ...
    def test_unzip_multiple_items_key_not_exists_between_rank_1(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=keys[median_idx],
            expected_left_keys=expected_left_keys,
            expected_right_keys=expected_right_keys,
            has_key_subtree=False,
        )
    ...
    def test_unzip_multiple_items_key_not_exists_between_rank_gt_1(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=keys[median_index + 1],
            expected_left_keys=expected_left_keys,
            expected_right_keys=expected_right_keys,
            has_key_subtree=False,
        )
    ...
    def test_unzip_complex_tree_structure(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=keys[unzip_idx + 1],
            expected_left_keys=expected_left_keys,
            expected_right_keys=expected_right_keys,
    ...
    def test_unzip_preserves_tree_properties(self):
        ...
        left_tree, key_subtree, right_tree, _next_entry = tree.unzip(250)
    ...
    def test_unzip_invalidates_cached_sizes(self):
        ...
        # Perform unzip
        left_tree, _key_subtree, right_tree, _next_entry = tree.unzip(250)
    ...
    def test_unzip_with_klist_sets(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=200,
            expected_next_key=300,
            expected_left_keys=[100],
            expected_right_keys=[300],
            has_key_subtree=False,
        )
    ...
    def test_unzip_with_gkplus_sets(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=120,
            expected_next_key=130,
            expected_left_keys=expected_left,
            expected_right_keys=expected_right,
            has_key_subtree=False,
        )
    ...
    def test_unzip_large_tree(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=unzip_key,
            expected_next_key=expected_right[0] if expected_right else None,
            expected_left_keys=expected_left,
            expected_right_keys=expected_right,
            has_key_subtree=False,
        )
    ...
    def test_unzip_boundary_values(self):
        ...
        self._validate_unzip_result(
            ...
            unzip_key=10000,
            expected_next_key=None,
            expected_left_keys=[100, 200, 300],
            expected_right_keys=[],
            has_key_subtree=False,
        )
    ...
    def test_unzip_sequential_operations(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=300,
            expected_next_key=400,
            expected_left_keys=[100, 200],
            expected_right_keys=[400, 500],
            has_key_subtree=False,
        )
        ...
        if not right_tree.is_empty():
            ...
            self._validate_unzip_result(
                ...
                next_entry2,
                unzip_key=450,
                expected_next_key=500,
                expected_left_keys=[400],
                expected_right_keys=[500],
                has_key_subtree=False,
            )
    ...
    def test_unzip_maintains_leaf_structure(self):
        ...
        if not left_tree.is_empty():
            ...
            assert_tree_invariants_tc(self, left_tree, left_stats, exclude_checks=["set_thresholds_met"])
        ...
        if not right_tree.is_empty():
            ...
            assert_tree_invariants_tc(
                self, right_tree, right_stats, exclude_checks=["internal_packed", "set_thresholds_met"]
            )
    ...
    def test_unzip_with_dummy_entries(self):
        ...
        self._validate_unzip_result(
            ...
            next_entry,
            unzip_key=dummy_key,
            expected_next_key=100,
            expected_left_keys=[],
            expected_right_keys=[100, 200, 300],

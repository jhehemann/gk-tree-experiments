...
from gplus_trees.g_k_plus.utils import calc_rank, calc_rank_from_group_size, calc_ranks, calc_ranks_multi_dims
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_calc_ranks_function(self):
        ...
        for i, key in enumerate(keys):
            ...
            self.assertEqual(ranks[i], expected_rank, f"Rank for entry {i} should match individual calculation")
